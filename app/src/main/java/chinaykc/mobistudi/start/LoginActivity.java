...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mTvMore = (TextView) findViewById(R.id.tv_more);
    ...
    private void attemptLogin() {
        ...
        mSnackbar.setText("Checking user data...");
        mSnackbar.show();
        //Toast.makeText(this, "Checking user data...", Toast.LENGTH_SHORT).show();

        //get user datas
        String data = null;
        try {
            data = FileHelper.readFile("users",user,"json");
        } catch (IOException e) {
            e.printStackTrace();
            data = e.toString();
        }

        StudyUser sUser = null;
        if(data != FileHelper.NOT_FIND)
             sUser = new Gson().fromJson(data,StudyUser.class);

        if(sUser != null && password.equals(sUser.getPassword()))
        {
            mSnackbar.setText("Loading user data...");
            EventBus.getDefault().post(new LoginFinishedEvent(new Gson().toJson(sUser)));
        } else {
            mSnackbar.setText(data);
        }
